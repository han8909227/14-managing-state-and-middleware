...
(function(module) {
  ...
  // the render function sets up the Handlebars template and compiles with the return statement. articleView.index includes articles.forEach, which appends each article to the DOM, as an argument to render
